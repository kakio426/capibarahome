...
| 항목 | LOC/bytes | 감사 판정 |
| --- | ---: | --- |
| 순수 handwritten runtime 구현 `src/app src/core src/game src/state src/systems src/ui` | 7,781 LOC | 실제 gameplay/UI/system 구현 규모. RC-5 CSS component split 포함 |
| 순수 handwritten unit/E2E tests `src/tests e2e` excluding generated matrix | 2,289 LOC | 실제 사람이 작성한 검증 규모 |
| 순수 handwritten gameplay/UI/system/test 합계 | 10,070 LOC | 이번 감사의 기준값 |
...
| handwritten runtime+test byte size | 345,234 bytes | docs/build/assets 제외 기준 |
