...
- 직접 제작한 SVG visual asset pack 253개와 UI registry 연결
- final home/prestige/shop/offline/store key visual 후보와 store screenshot 후보 10장
...
- 현재 visual은 프로젝트 내부 수제 SVG + CSS scene + final key visual 후보이며, commissioned store art로 교체할 수 있도록 registry/component 구조를 둡니다. 스토어 후보 이미지는 `store-screenshots/`에 있습니다.
