...
- 직접 제작한 SVG visual asset pack 245개와 UI registry 연결
...
- 현재 visual은 프로젝트 내부 수제 SVG + CSS scene RC asset이며, final store art로 교체할 수 있도록 registry/component 구조를 둡니다. 스토어 후보 이미지는 `store-screenshots/`에 있습니다.
