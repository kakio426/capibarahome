...
| 핵심 raster game art | `src/assets/raster/home/`, `companions/`, `release/` | built-in image generation으로 생성 후 chroma-key removal/crop/resize 후처리 | 외부 스톡/CDN/경쟁작 에셋 미사용. 최종 제출 전 사용자 법무/소유권 검토 필요 |
...
| Final key visual 후보 | `main-hero-background.png`, `main-capybara-character.png`, `prestige-ritual.png`, `shop-reward-banner.png`, `offline-reward.png`, `store-key-visual.png` | generated raster candidate | Playwright QA/store screenshot pack에 연결됨 |
...
- 현재 자산은 release candidate용 직접 제작 SVG auxiliary pack + generated raster core art pack이다. 실제 스토어 제출 전 commissioned/final art 소유권, app icon PNG, adaptive icon, splash image export를 확정해야 한다.
